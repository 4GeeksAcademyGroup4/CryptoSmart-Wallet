								...
								<div className="flip-box-ab p-1  text-light">
									<div className="flip-box-inner">
										...
										<div className="flip-box-back mx-2 text-light">
											<h3 className="text-light mt-4">Jairo Castro</h3>
							...
							<div className="col">
								<div className="flip-box-ab p-1  text-light">
									<div className="flip-box-inner">
										...
										<div className="flip-box-back mx-2 text-light">
											<h3 className="text-light mt-4">Jonathan Piedra</h3>
											<p>Full Stack Web deveoper</p>
											<p>johmstone</p>
							...
							<div className="col">
								<div className="flip-box-ab p-1  text-light">
									<div className="flip-box-inner">
										...
										<div className="flip-box-back mx-2 text-light">
											<h3 className="text-light mt-4">Alejandro Guerrero</h3>
											<p>Full Stack Web deveoper</p>
											<p>aleguerrerom</p>
							...
							<div className="col">
								<div className="flip-box-ab p-1 text-light">
									<div className="flip-box-inner">
										...
										<div className="flip-box-back mx-2 text-light">
											<h3 className="text-light mt-4">Miguel Vargas</h3>
											<p>Full Stack Web deveoper</p>
											<p>Mivargasg</p>
